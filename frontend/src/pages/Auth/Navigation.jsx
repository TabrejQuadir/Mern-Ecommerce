...
const Navigation = () => {
  ...
  return (
    <div id="navigation-container" className="flex flex-col justify-between p-4 text-white bg-black">
      ...
      <div className="relative">
        ...
        {dropdownOpen && userInfo && (
          <ul
            className={`absolute right-0 mt-2 mr-14 space-y-2 bg-yellow-100 text-gray-600 ${
              !userInfo.isAdmin ? "bottom-20" : "bottom-10"
            }`}
          >
            {userInfo.isAdmin && (
              <>
                <li className="hover:bg-gray-100 hover:font-bold">
